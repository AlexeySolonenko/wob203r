 ...
 */
const CoursesBusinessGeneralPage = ({ allowedRoutes }) => {
    ...
    const k = {
        heroCard: {
            ...
            title: "КРАТКОСРОЧНЫЕ БИЗНЕС КУРСЫ",
        ...
        description: ' Английский для бизнеса то, это то это то это то это   это то это то это о то это то это то это  это то это то это то это  это то это то это то это  это то это то это то это  это то это то это то это  это то это то это то это  это то это то это то это  это то это то это то это  это то это то это то это  это то это то это то это ',
        factSheet: {
...
export default CoursesBusinessGeneralPage;
